...
<body>
	<div id="overlay">
		<h1>Gebruiker toevoegen</h1>
			...
			<form action="edit/addUser.php" method="post" name="nieuwUser">
		
			Gebruikersnaam: <input type="text" name="username" maxlength="3"><br>
			Wachtwoord: <input type="password" name="password" id=""> (<input type="checkbox" onchange="validate.pass(this)"/> Toon wachtwoord)<br>
